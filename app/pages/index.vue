    ...
    <section id="certifications" class="my-12 py-12 relative">
        <div class="container">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-12">
                <div v-for="(item, index) in certifications" :key="index" class="flex flex-col items-center gap-4 border border-[#A7A7A7] rounded-3xl py-4 md:py-12 px-4" data-aos="fade-right" :data-aos-delay="index * 100">
            ...
            <div class="container">
                <div class="flex justify-between">
                    <div class="w-1/2 pr-4 md:pr-12 py-12 border-r-[0.5px] border-white">
                        ...
                        <AnimatedCounter :end-val="5368780" :duration="3" :decimal-places="0" suffix="+" wrapper-class="text-3xl md:text-7xl mt-4" data-aos="fade-up" />
                    </div>
                    <div class="w-1/2 pl-4 md:pl-12 py-12 border-l-[0.5px] border-white">
                        ...
                        <AnimatedCounter :end-val="441922" :duration="3" :decimal-places="0" suffix=" kg+" wrapper-class="text-3xl md:text-7xl mt-4" data-aos="fade-up" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="md:w-2/5">
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-1" data-aos="fade-up">
                            ...
                            <textarea v-model="form.message" id="message" class="w-full bg-transparent p-2 text-sm border border-[#A9A9A9] resize-none" rows="10" placeholder="Insert your Message"></textarea>
...
const partners = [
    ...
    { icon: "marini", alt: "Marini logo" },
    { icon: "kraken", alt: "Kraken logo" },
    { icon: "gatsby", alt: "Gatsby logo" },
    { icon: "terra", alt: "Terra logo" },
    { icon: "almayass", alt: "Almayass logo" },
    { icon: "joes-cafe", alt: "Joe's Cafe logo" },
    { icon: "parlour", alt: "Parlour logo" },
    { icon: "new-shanghai", alt: "New Shanghai logo" },
    { icon: "claw-bbq", alt: "Claw BBQ logo" },
    // { icon: "goldfish", alt: "Goldfish logo" },
    { icon: "coffee-club", alt: "Coffee Club logo" },
    { icon: "sufret-maryam", alt: "Sufret Maryam logo" },
    ...
    { icon: "the-hut", alt: "The Hut Logo" },
    { icon: "sirali", alt: "Sirali Logo" },
    { icon: "la-letizia", alt: "La Latizia Logo" },
    { icon: "jamies-oliver", alt: "Jamies Oliver Logo" },
    ...
    { icon: "syrovarnya", alt: "Syrovarnya Logo" },
    ...
    { icon: "punjab-grill", alt: "Punjab Grill Logo" },
    { icon: "saya", alt: "Saya Logo" },
    { icon: "the-sib", alt: "The Sib Logo" },
    { icon: "supa", alt: "SUPA Logo" },
...
const handleSubmit = async () => {
    ...
    try {
        const API_ENDPOINT = 'https://api.eaulawater.com/wp-json/contact-form-7/v1/contact-forms/6/feedback';
